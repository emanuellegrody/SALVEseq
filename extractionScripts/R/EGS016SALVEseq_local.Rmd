...
# Configuration
# =============================================================================
base_dir <- "R:/Basic_Sciences/CDB/GoyalLab/People/EmmieGrody/Data/EGS/extractedData/EGS016/"
load_dir <- paste0(base_dir, "singleCell/cNMF/subpattern/")
rds_dir <- paste0(base_dir, "singleCell/Seurat/RDS/")
...
for (i in 1:length(samples)) {
  ...
  output_dir <- paste0(base_dir, "joint/plots/cNMF/subpattern/", run_name, "/")
  if (!dir.exists(output_dir)) {
    dir.create(output_dir, recursive = TRUE)
  }
