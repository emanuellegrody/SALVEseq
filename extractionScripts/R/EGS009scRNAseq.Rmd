...
reads_GEX <- read.csv(paste0(input.dir, "P_acute_combined_bamsort_split_inside.csv"))
...
results_file <- paste0(output.dir, "Pacute_combined_sample_cellID_results.csv")
summary_file <- paste0(output.dir, "Pacute_combined_sample_cellID_summary.csv")
...
results_file <- paste0(output.dir, "Pacute_combined_sample_UMI_results.csv")
summary_file <- paste0(output.dir, "Pacute_combined_sample_UMI_summary.csv")
write.csv(results, results_file, row.names = FALSE)
write.csv(summary, summary_file, row.names = FALSE)

#results <- read.csv(paste0(output.dir, "Pacute_sample_UMI_results.csv"))
results <- sample_UMI_weighted(reads_GEX, percentages = c(seq(10, 99, by = 10)))

model_results <- fit_models(results, target_coverage = 90)




# To sequence more or not to sequence more?
decision <- make_sequencing_decision(reads_GEX, target_coverage = 90, coverage_column = "pair_coverage")
