...
Pacute_SALVE <- read.csv("/projects/b1042/GoyalLab/egrody/extractedData/EGS013/SALVE/bamsort/Pacute_SALVE_filtered.csv")
...
results_file <- paste0(output.dir, "GEX_sample_cellID_results.csv")
summary_file <- paste0(output.dir, "GEX_sample_cellID_summary.csv")
write.csv(results, results_file, row.names = FALSE)
write.csv(summary, summary_file, row.names = FALSE)

results <- sample_UMI_weighted(reads_GEX)
summary <- analyze_UMI_sampling(results, title = paste0("Weighted UMI Saturation: GEX"))
results_file <- paste0(output.dir, "GEX_sample_UMI_results.csv")
summary_file <- paste0(output.dir, "GEX_sample_UMI_summary.csv")
write.csv(results, results_file, row.names = FALSE)
write.csv(summary, summary_file, row.names = FALSE)
