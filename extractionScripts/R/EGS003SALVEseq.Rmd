...
```{r}
input.dir <- "/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/EGS002/Mmul_10_mac239full/"
...
input.dir <- "/projects/b1042/GoyalLab/egrody/20231017_EGS002/counts/Mmul_10_mac239env/"
SingleCell_umap_env <- read.csv(paste0(input.dir, "invitro_Mmulmacenv_mac239.csv"))
SingleCell_umap_env <- SingleCell_umap_env %>% 
  rename(log1pSingleCell = mac239) %>% select(-X)
```


### Loading in SALVEseq reads
Now loading the SALVEseq v2 reads. To use cellranger count instead, jump down to chunk 13.
```{r}
PL_env <- SeuratSALVEseq("/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/counts/count_PLenv_Mmul10env/outs/filtered_feature_bc_matrix/", 
                     "PL_env", 
                     output_dir = "/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/Seurat/Mmul_10_env/PL_env/", plots = FALSE)
...
PL_env <- SeuratSALVEseq("/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/counts/count_PLenv_Mmul10env/outs/filtered_feature_bc_matrix/", 
                     ...
                     output_dir = "/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/Seurat/Mmul_10_env/PL_env/", plots = FALSE)
PL_env_clean <- targetExpressionDF(PL_env, "env")
PL_env_clean <- PL_env_clean %>% filter(env > 0.7) %>% mutate(cellID = str_sub(cellID, 1, -3)) %>%
  rename(log1pSALVE = env)
...
### envupstream vs envdownstream vs SALVE
...
output_dir <- "/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/EGS002/Mmul_10_only/invitro/plots/"
invitro <- SeuratPipeline("/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/EGS002/Mmul_10_only/invitro/filtered_feature_bc_matrix/", "invitro")
dplot <- DimPlot(invitro, reduction = "umap")
ggsave(dplot, file = paste0(output_dir, "invitro_umap.svg"))
invitro_coords <- export_cell_metadata(invitro,                            "/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/EGS002/invitro_umapclusters.csv")
...
### SALVE
```{r}
invitro_coords <- read.csv("/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/EGS002/invitro_umapclusters.csv")
...
output_dir <- "/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/joint/Mmul_10_onlyclusters/"
...
```{r}
input.dir <- "/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/EGS002/"
...
#invitro <- readRDS(file = paste0("/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/EGS002/", "invitro.rds")) #reload invitro from RDS
...
output.dir <- "/projects/b1042/GoyalLab/egrody/20240116_EGS003_004/EGS003/joint/Mmul_10_onlyclusters/DEG_SALVE/"
