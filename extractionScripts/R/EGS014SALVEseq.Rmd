...
process_bamsortv5(samples$samples, input.dir, output.dir, raw_cellIDs)z
...
# UMI lists
SALVE.dir <- "/projects/b1042/GoyalLab/egrody/extractedData/EGS014/SALVE/bamsort/reads/v6/"
...
for (sample_name in names(samples)) {
  ...
  for (file in samples[[sample_name]]) {
    ...
    file_data <- data %>%
      filter(CB %in% salve_umi$cellID & UB %in% salve_umi$UMI) %>%
