...
output.dir <- "/projects/b1042/GoyalLab/egrody/extractedData/EGS014/singleCell/bamsort/reads/20250521/"
...
for (i in 1:nrow(samples)) {
  ...
  is_relevant <- sapply(filenames, is_v4bamsort_SALVE)
...
output.dir <- "/projects/b1042/GoyalLab/egrody/extractedData/EGS014/SALVE/bamsort/reads/20250520/withLTR"
...
# Example paths
input_dir <- "/projects/b1042/GoyalLab/egrody/extractedData/EGS014/SALVE/bamsort/reads/20250520/withoutLTR"
output_dir <- "/projects/b1042/GoyalLab/egrody/extractedData/EGS014/SALVE/bamsort/reads/20250520/converted/withoutLTR"
...
# Process all samples
process_all_samples_umi_to_salve(samples, input_dir, output_dir, min_reads = 1, min_region_count = 1, min_umi_count = 2)
