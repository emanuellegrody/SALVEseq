...
INPUT_CSV="/projects/b1042/GoyalLab/egrody/extractedData/EGS013/joint/left_onlySALVE.csv"         				# Path to CSV file with cell IDs
OUTPUT_DIR="/projects/b1042/GoyalLab/egrody/extractedData/EGS009/singleCell/bamsort/"           				# Directory to save output
OUTPUT_FILENAME="Pacute_bamsort_onlySALVE"            									# Prefix for output file
