...
# NO path to the sample CSV file -- samples hardcoded
INPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGS009/singleCell/counts/subsample/Mmul_10_mac239_"
...
# Base paths
OUTPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGS009/singleCell/bamsort/alignment/subsample/"
...
try:
    # Hardcoded samples
    samples = ["P_acute_150M", "P_acute_200M", "P_acute_300M", "P_acute_400M"]
    ...
    for sample in samples:
        ...
        bam_file = f"$INPUT_ROOT{sample}/outs/possorted_genome_bam.bam"
