...
# =============================================================================
# Input/Output paths
export CNMF_INPUT_H5AD="/projects/b1042/GoyalLab/egrody/extractedData/EGS016/singleCell/Seurat/RDS/invitro.h5ad"
export CNMF_OUTPUT_DIR="/projects/b1042/GoyalLab/egrody/extractedData/EGS016/singleCell/cNMF"
export CNMF_RUN_NAME="invitro"

# cNMF parameters
export CNMF_K_RANGE="6,7,8"         # Comma-separated K values to test
export CNMF_N_ITER=200              # NMF iterations per K
export CNMF_N_HVG=2000              # Number of highly variable genes
export CNMF_SEED=42                 # Random seed for reproducibility
