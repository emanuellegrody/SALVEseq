...
# Base paths
OUTPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGS016/singleCell/bamsort/alignment/v5/"
...
try:
    ...
    for sample_data in samples_data:
        ...
        bam_file = f"{folder}Mmul_10_mac239v5_{dataset}/outs/possorted_genome_bam.bam"
