...
SAMPLES_CSV="/projects/b1042/GoyalLab/egrody/extractionScripts/submissionScripts/GEX_samples.csv"
# Path to the coordinates CSV file
COORDS_CSV="/projects/b1042/GoyalLab/egrody/extractionScripts/submissionScripts/bamsort_coordinates.csv"
# Base paths
OUTPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGS014/singleCell/bamsort/alignment/"
...
try:
    ...
    for sample_data in samples_data:
        ...
        # Construct the BAM file path using the folder + "Mmul_10_mac239_" + dataset + "/outs/possorted_genome_bam.bam"
        bam_file = f"{folder}Mmul_10_mac239_{dataset}/outs/possorted_genome_bam.bam"
