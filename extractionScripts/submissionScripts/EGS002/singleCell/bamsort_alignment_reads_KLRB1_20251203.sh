...
# Base paths
INPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGS002/singleCell/counts/concat/Mmul_10_mac239_"
INPUT_END="/outs/possorted_genome_bam.bam"
OUTPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGS002/singleCell/bamsort/alignment/concat_subsample/"
...
try:
    # Hardcoded samples
    samples = ["W0_concat_150M", "W0_concat_200M", "W0_concat_300M", "W0_concat_400M"]
    ...
    for sample in samples:
        ...
        output_file = f"$OUTPUT_ROOT{sample}_GEX_bamsort_alignment_{target}.csv"
