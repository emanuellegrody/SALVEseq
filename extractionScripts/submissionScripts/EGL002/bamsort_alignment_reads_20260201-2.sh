...
#SBATCH -A b1042
#SBATCH -p genomics
#SBATCH --job-name=bamsort-EGL
#SBATCH -N 1
#SBATCH -n 4
#SBATCH --mem=1G
#SBATCH -t 0:10:00
#SBATCH --output=logs/bamsort_EGL_%j.txt
#SBATCH --error=logs/bamsort_EGL_%j.err
#SBATCH --verbose
...
# Paths to the sample and coords files
SAMPLES_CSV="/projects/b1042/GoyalLab/egrody/extractionScripts/submissionScripts/mkcounts_v3.csv"
COORDS_CSV="/projects/b1042/GoyalLab/egrody/extractionScripts/submissionScripts/bamsort_v3_coordinates.csv"
# Base paths
INPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGL002/SALVE/counts/nointron/GRCm39_"
INPUT_END="/outs/possorted_genome_bam.bam"
OUTPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGL002/SALVE/bamsort/nointron/"
SCRIPT_PATH="/projects/b1042/GoyalLab/egrody/extractionScripts/Python/bamsort_alignment_reads_liver.py"
