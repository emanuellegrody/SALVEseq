...
#SBATCH -A b1042
#SBATCH -p genomics
#SBATCH --job-name=bamsort-SALVE-combined
#SBATCH -N 1
#SBATCH -n 4
#SBATCH --mem=2G
#SBATCH -t 1:00:00
#SBATCH --output=logs/bamsort_SALVE_combined_%j.txt
#SBATCH --error=logs/bamsort_SALVE_combined_%j.err
#SBATCH --verbose
...
# Base directories
INPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGL002/SALVE/counts/GRCm39_EGL002_"
INPUT_END="/outs/possorted_genome_bam.bam"

# Output directories
ALIGNMENT_OUTPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGS024/SALVE/bamsort/alignment/"
SPLICE_OUTPUT_DIR="/projects/b1042/GoyalLab/egrody/extractedData/EGS024/SALVE/bamsort/splice"
SPLICE_FILTERED_DIR="/projects/b1042/GoyalLab/egrody/extractedData/EGS024/SALVE/bamsort/splice/combined"
