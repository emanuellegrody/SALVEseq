...
#SBATCH -A b1042
#SBATCH -p genomics
#SBATCH --job-name=bamsort-EGLv3
#SBATCH -N 1
#SBATCH -n 4
#SBATCH --mem=1G
#SBATCH -t 0:10:00
#SBATCH --output=logs/bamsort_EGLv3_%j.txt
#SBATCH --error=logs/bamsort_EGLv3_%j.err
#SBATCH --verbose
...
# Base paths
INPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGL001/bams_final/"
INPUT_END="_final.bam"
OUTPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGL001/SALVE/bamsort/"
