...
OUTPUT_DIR="/projects/b1042/GoyalLab/egrody/extractedData/EGS007/longRead/bamsort/isoform"
...
for SAMPLE_NAME in "${SAMPLES[@]}"; do
    ...
    # Output CSV filename
    OUTPUT_FILENAME="${SAMPLE_NAME}_isoforms.csv"
    ...
    python3 /projects/b1042/GoyalLab/egrody/extractionScripts/Python/bamsort_isoform_longread.py \
        "$INPUT_BAM" \
        "$OUTPUT_CSV"
done
