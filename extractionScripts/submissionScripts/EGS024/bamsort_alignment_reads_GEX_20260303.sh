...
# Base paths
INPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGS024/singleCell/counts/concat/Mmul_10_mac239_GFP_"
INPUT_END="/outs/possorted_genome_bam.bam"
OUTPUT_ROOT="/projects/b1042/GoyalLab/egrody/extractedData/EGS024/GEX/bamsort/alignment/"
...
# Check if coordinates CSV exists (always required)
