...
/projects/b1042/GoyalLab/egrody/packages/cellranger-7.2.0/cellranger mkref --genome=Mmul_10_mac239full --fasta=Macaca_mulatta.Mmul_10.dna.toplevel.mac239full.fa --genes=Macaca_mulatta.Mmul_10.110.filtered.mac239full.gtf --ref-version=1.0.0 --memgb=110